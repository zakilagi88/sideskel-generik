        ...
        @if (count($getState()) > 5)
            <div id="more1" style="display: none;">
                ...
                <a href="#more1"
                    ...
                    onclick="document.getElementById('more1').style.display = 'none'; document.getElementById('showMore1').style.display = 'block';">Tutup</a>
            </div>
            <a id="showMore1" href="#showMore1"
                class="text-sm text-right text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 block"
                onclick="document.getElementById('more1').style.display = 'block'; this.style.display = 'none';">Tampilkan
                Selengkapnya</a>
        @endif
    @endif
</div>
