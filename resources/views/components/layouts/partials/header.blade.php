        <nav id="navbar"
            ...
            <div class="flex justify-around items-center gap-4">
                ...
                <ul class="hidden md:flex space-x-6">
                    ...
                    <li class=" hover:bg-slate-100 text-white hover:text-black rounded-lg px-2"><a
                            href="#">Berita</a></li>
                    ...
                    <ul class="bg-gray-200 shadow-lg  leading-9 font-bold ">
                        ...
                        <li class="border-b-2 border-white hover:bg-red-400 hover:text-white">
                            ...
                            <ul class="bg-white text-gray-800 w-full">
                                <li class="text-sm leading-8 font-normal hover:bg-slate-200 rounded-lg"><a
                                        class="block pl-16" href="#">Data Penduduk</a></li>
