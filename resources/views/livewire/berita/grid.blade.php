                        ...
                        <div class="bg-transparent dark:bg-gray-800 dark:text-gray-50">
                            ...
                            <div class="flex flex-col p-6 col-span-full row-span-full lg:col-span-8 lg:p-10">
                                <div class="flex justify-start">
                                    ...
                                    <span
                                        class="px-2 py-1 text-xs rounded-full dark:bg-violet-400 dark:text-gray-900">{{ str($b->kategori->name)->ucFirst() }}</span>
                                </div>
                                ...
                                <div class="flex items-center justify-between pt-2">
                                    <div class="flex space-x-2">
                                        ...
                                        <span class="self-center text-sm">{{ $b->author->name }}</span>
                                    </div>
                                    <span class="text-xs">Perkiraan Waktu Membaca
                                        {{ $b->getReadingTime() }}</span>
                                </div>
                            </div>
                        </div>
            </div>
