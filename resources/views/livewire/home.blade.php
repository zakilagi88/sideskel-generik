<div class="my-4 rounded-xl bg-primary">
    ...
    <div class="flex flex-col justify-center">
        ...
        <div class="dark:bg-gray-800 dark:text-gray-100">
            ...
            <div
                class="container bg-black bg-opacity-20 rounded-3xl pb-4 flex flex-col mx-auto transition-all duration-500 ease-in-out">
                @livewire('components.stat-info')
            </div>
        </div>


        <div class="flex flex-col lg:flex-row bg-white items-center pt-24 justify-center" data-aos="fade-in">
    ...
    {{-- @livewire('widgets.tables.penduduk.agama-table') --}}
    ...
    {{-- <section class="pb-20 bg-white rounded-t-3xl" data-aos="fade-up">
            <div class="container flex flex-col mx-auto px-4 transition-all duration-500 ease-in-out">
                <div class="flex mt-6 justify-center items-center flex-col text-center">
                    <h1 class="text-2xl font-bold sm:text-3xl whitespace-nowrap">Administrasi Penduduk
                        <span class="font-normal">{{ $deskel->sebutan }}
                            {{ ucwords(strtolower($deskel->dk->deskel_nama)) }}</span>
