...
CREATE TABLE deskel_profils (
  id bigint unsigned AUTO_INCREMENT,
  deskel_id varchar(10)  ,
  deskel_tipe varchar(255)  ,
  deskel_alamat varchar(255)  ,
  deskel_kodepos varchar(255)  ,
  deskel_luaswilayah double ,
  deskel_jumlahpenduduk int ,
  deskel_batas_utara varchar(255)  ,
  deskel_batas_timur varchar(255)  ,
  deskel_batas_selatan varchar(255)  ,
  deskel_batas_barat varchar(255)  ,
  deskel_visi longtext ,
  deskel_misi longtext ,
  deskel_sejarah longtext ,
  deskel_gambar varchar(255)  ,
  deskel_logo varchar(255)  ,
  deskel_telepon varchar(255)  ,
  deskel_email varchar(255)  ,
  created_at timestamp  ,
  updated_at timestamp  ,
  PRIMARY KEY (id),
);
