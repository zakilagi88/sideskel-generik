...
use App\Livewire\Widgets\{Charts\Penduduk\RentangUmurChart, Tables\Penduduk\RentangUmurTable};
...
class PendudukRentangUmur extends Page
{
    ...
    protected static ?string $slug = 'penduduk-rentang-umur';
    ...
    {
        return [
            RentangUmurTable::class,
            RentangUmurChart::class,
        ];
    }
}
