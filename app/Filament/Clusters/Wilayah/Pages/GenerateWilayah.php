...
use App\Livewire\WilayahWidget;
...
class GenerateWilayah extends Page implements HasForms
{
    ...
    protected static ?string $navigationLabel = 'Kewilayahan';

    protected static string $view = 'filament.clusters.wilayah-administratif.pages.index';
    ...
    {
        $this->deskel = $deskel::with('dk.kec.kabkota.prov', 'dk.kec.kabkota', 'dk.kec', 'dk')->first() ?? new DesaKelurahanProfile();
    }
