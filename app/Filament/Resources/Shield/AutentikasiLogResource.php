...
use App\Filament\Resources\Shield\AutentikasiLogResource\Pages\ListAutentikasiPenggunas;
...
class AutentikasiLogResource extends Resource implements HasShieldPermissions
{
    protected static ?string $model = AuthenticationLog::class;

    protected static ?string $slug = 'autentikasi-pengguna';
    ...
    {
        return [
            'index' => ListAutentikasiPenggunas::route('/'),
        ];
    }
