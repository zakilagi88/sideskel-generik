...
use App\Livewire\Widgets\Tables\Penduduk\PekerjaanTable;

use App\Models\Penduduk\PendudukPekerjaan;
...

{
    ...
    protected static ?string $chartId = 'pekerjaan-chart';
    ...
    protected function getData(): array
    {
        ...
        return [
            'pekerjaan' => array_column($items, 'pekerjaan'),
    ...
    protected function getOptions(): array
    {
        ...
        $options =
            [
                ...
                'xaxis' => [
                    'categories' => $pekerjaan['pekerjaan'],
                    'labels' => [
                        'style' => [
                            'fontWeight' => 400,
                            'fontFamily' => 'inherit'
