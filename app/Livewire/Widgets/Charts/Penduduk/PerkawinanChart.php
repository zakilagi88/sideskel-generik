...
use App\Livewire\Widgets\Tables\Penduduk\PerkawinanTable;

use App\Models\Penduduk\PendudukPerkawinan;
...

{
    ...
    protected static ?string $chartId = 'perkawinan-chart';
    ...
    protected function getData(): array
    {
        ...
        return [
            'status_perkawinan' => array_column($items, 'status_perkawinan'),
    ...
    protected function getOptions(): array
    {
        ...
        $status_perkawinan = $this->getData();
        ...
        $options =
            [
                ...
                'xaxis' => [
                    'categories' => $status_perkawinan['status_perkawinan'],
                    'labels' => [
                        'style' => [
                            'fontWeight' => 400,
                            'fontFamily' => 'inherit'
