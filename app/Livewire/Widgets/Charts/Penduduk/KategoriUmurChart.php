...
use App\Livewire\Widgets\Tables\Penduduk\KategoriUmurTable;

use App\Models\Penduduk\PendudukKategoriUmur;
...
class KategoriUmurChart extends ApexChartWidget
{
    use InteractsWithPageFilters;

    protected static ?string $loadingIndicator = 'Loading...';
    protected static ?string $chartId = 'kategori-umur-chart';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'Grafik Penduduk Berdasarkan Kategori Umur';
    ...
    protected function getData(): array
    {
        ...
        return [
            'kategori_umur' => array_column($items, 'kategori_umur'),
